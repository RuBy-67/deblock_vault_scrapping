...
(function () {
  ...
  var fmtN = function (v) { return new Intl.NumberFormat('fr-FR').format(v); };

  if (!daily.length && !weeklyPay.length) return;
    ...
    new Chart(document.getElementById('chartActiviteJour'), {
      ...
      data: {
        ...
        datasets: [
          {
            label: 'Transferts',
            data: daily.map(function (d) { return d.n; }),
        ...
        datasets: [
          {
            ...
            data: nodeVolumeDaily.map(function (d) { return d.volumeEur; }),
            borderColor: '#0d9488',
        ...
        datasets: [
          {
            ...
            data: interestDaily.map(function (d) { return d.interestEur; }),
    ...
    new Chart(document.getElementById('chartPaymentTopupVolume'), {
      ...
      data: {
        ...
        datasets: [
          {
            label: 'Payment',
            data: dailyClass.map(function (d) { return d.payment; }),
            borderColor: '#7c3aed',
          ...
          {
            label: 'Top up',
            data: dailyClass.map(function (d) { return d.top_up; }),
            borderColor: '#ea580c',
      ...
      options: {
        ...
        scales: {
          ...
          y: {
            ticks: {
              callback: function (val) { return fmtEurAxis(val); },
            },
          },
        },
      },
        ...
        datasets: [
          {
            ...
            data: paymentAvgDaily.map(function (d) { return d.avgTicketEur; }),
            borderColor: '#6366f1',
    ...
    new Chart(document.getElementById('chartPaymentTopupCount'), {
      ...
      data: {
        ...
        datasets: [
          {
            label: 'Payment',
            data: dailyClass.map(function (d) { return d.nPayment; }),
          ...
          {
            label: 'Top up',
            data: dailyClass.map(function (d) { return d.nTopUp; }),
  ...
  if (weeklyPay.length) {
    var wlabels = weeklyPay.map(function (w) { return w.weekStart; });
    var wdata = weeklyPay.map(function (w) { return w.volumeEur; });
        ...
        data: {
          ...
          datasets: [
            ...
            },
            {
              ...
              data: wlabels.map(function () { return avgA; }),
              borderColor: '#0d9488',
            ...
            },
            {
              ...
              data: wlabels.map(function () { return avgC; }),
              borderColor: '#ca8a04',
              backgroundColor: 'transparent',
              borderWidth: 2,
              borderDash: [2, 3],
            ...
            },
            {
              ...
              data: weeklyPay.map(function (w) { return w.avgPerAccountEur; }),
              borderColor: '#4f46e5',
              backgroundColor: 'transparent',
              borderWidth: 2,
              pointRadius: 3,
            ...
            },
            {
              ...
              data: wlabels.map(function () { return avgDistinctPeriod; }),
              borderColor: '#c026d3',
              backgroundColor: 'transparent',
              borderWidth: 2,
              borderDash: [1, 4],
